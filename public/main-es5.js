...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppPublicServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AuthService(http, generalService) {
      ...
      _createClass(AuthService, [{
        ...
        value: function setAuthValues(_ref) {
          ...
          try {
            ...
            localStorage.removeItem("_token"); // localStorage.removeItem("_expiresIn");

            var _token = "".concat(data.token); //this.mainService.headers.append("authorization", "Bearer " + _token);
            ...
            localStorage.setItem("_token", _token); // localStorage.setItem("_expiresIn", JSON.stringify(_expiresIn.valueOf()));
    ...
    AuthService.ɵfac = function AuthService_Factory(t) {
      return new (t || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_general_service__WEBPACK_IMPORTED_MODULE_4__["GeneralService"]));
    };
